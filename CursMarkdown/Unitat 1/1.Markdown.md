...
Els processadors de text actuals, tipus LibreOffice o MS Office, segueixen un paradigma per a la creació de documents anomenat **WYSIWYG** (*What You See Is What You Get*, *el que veus és el que tens*). Aquest paradigma s'aplica tant a editors de text com a altres tipus d'editors, com puguen ser alguns editors web, i es basa en la possibilitat de poder escriure el document veient o treballant directament sobre el resultat final. El primer processador de text d'aquest tipus va ser *Bravo*, per a l'ordinador *Xerox Alto*, a la dècada dels 70.
