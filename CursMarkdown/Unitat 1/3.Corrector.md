...
![Configuració de l'idioma a Typora](img/typoraOrto1.png)
...
![Configuració de l'idioma a Typora](img/typoraOrto2.png)
...
![L'extensió LTeX](img/ltexExtension.png){ width = 60% }
...
![L'extensió LTeX](img/ltex1.png){ width = 60% }
...
![L'extensió LTeX](img/ltex2.png){ width = 40% }
...
![L'extensió LTeX](img/ltex5.png){ width = 60% }
...
![Configuració de les preferències](img/prefsVSCode.png){ width = 50% }
...
![Preferències d'LTeX](img/ltex3.png){ width = 80% }
...
![Selecció d'idioma](img/ltex4.png){ width = 80% }
